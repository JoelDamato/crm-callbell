...
app.post('/webhook/callbell', (req, res) => {
    ...
    (async () => {
        try {
            ...
            // Verificar la fecha de creación para procesar solo las del día actual
            ...
            if (
                ...
                console.log('El contacto no fue creado hoy, no se procesa');
                return;
            }
            ...
            const selectedTag = Array.isArray(tags) && tags.length > 0 ? tags[tags.length - 1] : "Prospecto";
